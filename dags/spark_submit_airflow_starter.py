...
local_script = "./dags/scripts/spark/test.py"
s3_script = "scripts/test.py"
s3_clean = "clean_data/movie/"
...
# Terminate the EMR cluster after Spark-job is done
